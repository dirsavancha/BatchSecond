...
**Byte Streams:Represent data in individual(1 byte) bytes.
   ...
   Eg: FileInputStream: Is used to read data  from a file in sequence of butes
       FileOutputStream
	   ObjectInputStream
	   ObjectOutputStream
	   BufferedInputStream
	   BufferedOutputStream.....etc
    Byte Streams are used to handle any type of imagesaudi and vedio files(which having 1 byte).
