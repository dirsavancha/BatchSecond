...
eg:
  ...
  Primitive data type define which stores the single value.
  eg: int i=10;
  ...
  Note :-
  We can call Non Primitive datat types through their refrence only so Primitve data types also called as Refrenced Data types.
...
eg:  University--->college-->branch
 ...
 Converting parent class to child class
   ...
   Second s=(Second)First();--Parent is pointing to child
...
**It is not safe and we cant use directly, we want to perform with refrence of the object as shown in above examole.
