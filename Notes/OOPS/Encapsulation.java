Encapsulation:--
def:-Encapsulating(combining) or binding dtata (variables)and methods in to a single unit is called Partilally Encapsulation
def2:- A class is fully encapsulated when data and method are comibined in to single unit as well data should be hide.
